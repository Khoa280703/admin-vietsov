  ...
  return (
    <div className="w-full h-full overflow-y-auto p-4 space-y-4">
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          <div className="grid grid-cols-1 gap-3">
            <div>
              <label className="text-sm font-medium mb-2 block">{t("metadata.authorId")}</label>
              <Input
                type="number"
                inputMode="numeric"
                value={article.authorId !== undefined ? String(article.authorId) : ''}
                onChange={(e) =>
                  onUpdate({ authorId: e.target.value ? Number(e.target.value) : undefined })
                }
              />
            </div>
            <div>
              <label className="text-sm font-medium mb-2 block">{t("metadata.categoryId")}</label>
              <Input
                type="number"
                inputMode="numeric"
                value={article.categoryId !== undefined ? String(article.categoryId) : ''}
                onChange={(e) =>
                  onUpdate({ categoryId: e.target.value ? Number(e.target.value) : undefined })
                }
              />
            </div>
            <div>
            ...
            <div className="space-y-2 pl-1">
              ...
              <label className="flex items-center gap-2 text-sm">
                <input
                  ...
                  onChange={(e) => onUpdate({ isBreakingNews: e.target.checked })}
                />
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <div>
            <label className="text-sm font-medium mb-2 block">{t("metadata.seoTitle")}</label>
            <Input
          ...
          <div>
            <label className="text-sm font-medium mb-2 block">{t("metadata.seoKeywords")}</label>
            <Input
