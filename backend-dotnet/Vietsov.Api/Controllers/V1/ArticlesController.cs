...
public class ArticlesController : ControllerBase
{
        ...
        [FromQuery] int? tagId = null)
    {
        try
        {
            ...
            if (!isAdmin)
            {
                query = query.Where(a => a.AuthorId == currentUserId.Value);
            }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            // User can only see their own articles, admin can see all
            if (!isAdmin && article.AuthorId != currentUserId.Value)
            {
                return Forbid();
            }
    ...
    private ArticleResponse MapToArticleResponse(Article article)
    {
        return new ArticleResponse
        {
            ...
            Author = article.Author != null ? new DTOs.Users.UserResponse
            {
