...
public class ArticleService : IArticleService
{
    ...
    public async Task<Article> SubmitArticleAsync(int articleId, int userId)
    {
        ...
        if (article.AuthorId != userId)
        {
            throw new UnauthorizedAccessException("You can only submit your own articles");
        }
    ...
    public async Task<Article> PublishArticleAsync(int articleId, int userId, bool isAdmin)
    {
        ...
        if (!isAdmin)
        {
            if (article.AuthorId != userId)
            {
                throw new UnauthorizedAccessException("You can only publish your own articles");
            }
