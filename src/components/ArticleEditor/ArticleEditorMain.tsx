...
import { calculateReadingTime, getWordCount, getCharacterCount } from '@/utils/readingTime';
      ...
      {showDraftPanel && (
        <div className="w-80 border-r bg-background overflow-hidden flex flex-col">
          <div className="flex items-center justify-between p-4 border-b">
            ...
            <Button size="icon" variant="ghost" onClick={() => setShowDraftPanel(false)}>
              <X className="h-4 w-4" />
            </Button>
          </div>
          <DraftList
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="border-b bg-background px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            {!showDraftPanel && (
              <Button size="icon" variant="ghost" onClick={() => setShowDraftPanel(true)}>
              ...
              onClick={() => {
                if (!isPreviewMode) {
                  ...
                  console.log('=== Preview Content ===', {
                    ...
                    jsonString: typeof article.content === 'object' 
        ...
        <div className="flex-1 flex overflow-hidden">
          <div className="flex-1 flex flex-col overflow-hidden">
            {!isPreviewMode && <Toolbar editor={editor} onFullscreen={() => setIsFullscreen(!isFullscreen)} />}
