...
export function ColorPicker({ editor, type, onClose, triggerRef }: ColorPickerProps) {
  ...
  return (
    <div
      className="color-picker-container fixed z-50 w-[180px] p-2 max-h-[400px] overflow-y-auto bg-white border border-gray-200 shadow-lg rounded-md"
      style={{
        top: `${position.top}px`,
    ...
    >
        <div className="space-y-2">
          ...
          <button
            onClick={handleReset}
            className="w-full flex items-center gap-2 px-2 py-1.5 text-[10px] text-gray-700 hover:bg-gray-100 rounded transition-colors"
            type="button"
          >
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-medium text-gray-700">CHUẨN</span>
              <Button
                variant="ghost"
                size="sm"
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-medium text-gray-700">TÙY CHỈNH</span>
